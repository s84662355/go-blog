<template>
    <article class="post post-list">
        <div class="post-entry">
            ...
            <div class="p-time">
                <i class="iconfont iconmeditor-time"></i> {{post.updated_at}}<i v-if="post.isHot" class="iconfont iconfire" style="margin-left: 5px;color: #ff6d6d;"></i>
            </div>
            ...
            <footer class="entry-footer">
                ...
                <div class="info-meta">
                    <div class="comnum" style="display:none">
                        <span>
                    ...
                    <div class="views">
                        <span><i class="iconfont iconeyes"></i>{{post.read_amount}} 热度</span>
                    </div>
                </div>
            </footer>
        </div>
