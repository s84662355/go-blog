                ...
                <article class="hentry">
                    ...
                    <header class="entry-header">
                        ...
                        <div class="breadcrumbs">
                            <div id="crumbs">最后更新时间：{{this.article.updated_at}}</div>
                        </div>
                    </header>
                    <!-- 正文输出 -->
                    <div class="entry-content">
                        ...
                        <div  v-for="item in  this.article .content">
    ...
    export default {
        ...
        created() {
            ...
            getArticle(this.id).then(res => {
                  ...
                  for(var x in  this.article .content){
                    this.menus.push({
                        title:this.article .content[x].title
                    })
                  }
